  ...
  return (
    <section className="md:container md:mx-auto mx-3">
                ...
                >
                  ...
                  >
                    <div className="flex gap-3 items-center">
                      ...
                      {locationValue
                        ? city.find((city: any) => city.value === locationValue)
                            ?.label
                ...
                >
                  ...
                  >
                    <div className="flex gap-3 items-center">
                      ...
                      {priceValue
                        ? biaya.find((biaya) => biaya.value === priceValue)
                            ?.label
                        : "Biaya Umroh/Haji..."}
                    </div>
                    <HiChevronUpDown />
      ...
      <div className="grid sm:grid-cols-1 gap-3 my-5 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {!paket_umroh &&
          loadingPage?.map((paket_umroh: any, index: number) => (
            <Skeleton
              key={index}
              className="p-3 hover:outline hover:outline-1 w-full h-[300px] shadow-md  hover:outline-blue-600"
            />
          ))}
