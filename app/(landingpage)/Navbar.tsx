      ...
      <section className="md:container md:mx-auto max-md:mx-3 flex items-center justify-between h-full">
        <div className="flex md:hidden items-center gap-3">
          <Sheet>
            ...
            <SheetContent side={'left'} className="bg-blue-dark text-white">
              <SheetHeader>
                <SheetTitle>
                  <Link href={'/'} className="text-white flex gap-1.5 items-center justify-center" title={process.env.NEXT_PUBLIC_APP_NAME ?? 'Logo'}>
                    <Image src={logo} width={500} height={500} className="w-[9rem]" alt={process.env.NEXT_PUBLIC_APP_NAME ?? 'Logo'} />
                    {/* <span className="text-yellow-700">{process.env.NEXT_PUBLIC_APP_NAME}</span> */}
                  </Link>
                </SheetTitle>
              </SheetHeader>
        ...
        <div className="flex gap-3 max-md:hidden">
          <h1 className="brand text-xl font-bold my-auto text-white/90">
            <Link href={'/'} className="text-white flex gap-1.5 items-center" title={process.env.NEXT_PUBLIC_APP_NAME ?? 'Logo'}>
              <Image src={logo} width={500} height={500} className="w-[9rem]" alt={process.env.NEXT_PUBLIC_APP_NAME ?? 'Logo'} />
              {/* <span className="text-yellow-50">{process.env.NEXT_PUBLIC_APP_NAME}</span> */}
            </Link>
          </h1>
