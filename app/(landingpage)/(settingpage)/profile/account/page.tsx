...
export default function AccountPage() {
  ...
  return (
    <section className="flex flex-col gap-3">
      ...
      <Separator />
      <form action="" method="post" className="flex gap-3 md:divide-x w-auto max-md:flex-col max-md:flex-col-reverse place-content-stretch">
        <div className="grid w-full max-md:gap-3 h-auto">
          ...
          <div className="grid items-center max-md:gap-1.5 w-full">
            ...
            <Input id="phone-number" type={'number'} placeholder="Masukkan Nomor Telepon anda..." />
          </div>
          <div>
        ...
        <div className="flex flex-col justify-center items-center p-3 w-full">
          <div className="flex flex-col items-center gap-3">
            <Image src={urlImage === '' ? avatar : urlImage} className="w-[8rem] object-cover rounded-full cursor-pointer" width={1024} height={1024} alt="My Profile" onClick={handleClick} />
