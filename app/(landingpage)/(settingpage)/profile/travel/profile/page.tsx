      ...
      <form action="" method="post" className="flex gap-3 md:divide-x w-auto max-md:flex-col max-md:flex-col-reverse">
        <div className="grid gap-3 w-full">
          ...
          <div className="grid items-center gap-1.5">
            ...
            <Textarea id="description" className="resize-none" placeholder="Deskripsikan tentang travel anda..." rows={4} />
          </div>
          <div className="grid items-center gap-1.5">
          ...
          <div className="grid items-center gap-1.5">
            ...
            <Input id="postal_code" type={'number'} placeholder="Masukkan Kode Pos..." />
          </div>
          <div className="grid items-center gap-1.5">
            <Label htmlFor="address">Alamat</Label>
            <Textarea id="address" className="resize-none" placeholder="Masukkan deskripsi disini..." rows={4} />
          </div>
          <div>
