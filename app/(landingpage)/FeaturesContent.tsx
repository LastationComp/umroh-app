        ...
        <Card className="p-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="flex flex-col items-center">
              <Image loading="lazy" src={'https://www.umroh.com/jaminan.png'} alt="Promo 1" width={200} height={300} />
            ...
            <div className="flex flex-col items-center">
              <Image loading="lazy" src={'https://www.umroh.com/fasilitas.png'} alt="Promo 1" width={200} height={300} />
            ...
            <div className="flex flex-col items-center">
              <Image loading="lazy" src={'https://www.umroh.com/promo.png'} alt="Promo 1" width={200} height={300} />
            ...
            <div className="flex flex-col items-center">
              <Image loading="lazy" src={'https://www.umroh.com/cicilan.png'} alt="Promo 1" width={200} height={300} />
