          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="flex flex-col items-center">
              ...
              <p className="text-black/60 text-center">
                Dana aman 100% dan hanya kami bayarkan kepada biro umroh setelah
                anda mendapatkan Kode PNR Penerbangan.
              </p>
            </div>
            <div className="flex flex-col items-center">
              <Image
              ...
              />
              <span className="text-[20px] text-center">
                Fasilitas saat Ibadah Umroh
              </span>
              <p className="text-black/60 text-center">
                Nikmati fasilitas seperti gratis biaya pembuatan atau
                perpanjangan Paspor, Internet Provider selama ibadah umroh.
              </p>
            </div>
            <div className="flex flex-col items-center">
              <Image
                ...
                blurDataURL={
                  "/api/image/blur?url=https://www.umroh.com/promo.png"
                }
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-black/60 text-center">
                Anda dapat memesan paket umroh yang Anda inginkan dengan DP
                Rp.5.000.000, dilanjutkan dengan pelunasan pembayaran yang harus
                diselesaikan Sebulan sebelum keberangkatan
              </p>
            </div>
            <div className="flex flex-col items-center col-span-1 md:col-span-2">
              ...
              <p className="text-black/60 text-center w-[400px]">
                Pemesanan paket umroh Anda langsung ditujukan ke biro umroh,
                tanpa melalui perantara/agent sehingga memastikan anda
