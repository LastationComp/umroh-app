      ...
      <ScrollArea className="h-[36rem]">
        <section className="flex flex-col gap-3 px-1">
          <div className="grid md:grid-cols-2 gap-5">
            <div>
              ...
              <Input
                ...
                required
                name="name"
                placeholder="Masukkan Nama Travel Kamu..."
              />
            </div>
            <div>
          ...
          <div className="grid md:grid-cols-2 gap-5">
            <div>
              ...
              <Input
                ...
                id="website"
                name="website"
                placeholder="Masukkan URL Website Kamu..."
              />
            </div>
            <div>
            ...
            <div>
              ...
              <Textarea
                ...
                id="address"
                rows={5}
                placeholder="Masukkan Alamat Perusahaan Kamu..."
              />
            </div>
            <div>
              ...
              <Textarea
                ...
                id="description"
                rows={5}
                placeholder="Gambarkan sedikit tentang travel kamu..."
              />
            </div>
          </div>
          ...
          <section>
            ...
            <CardDescription>
              Yuk beritahu kami apakah Perusahaan kamu aman dan legal.
            </CardDescription>
            <LegalityForm />
          </section>
        </section>
