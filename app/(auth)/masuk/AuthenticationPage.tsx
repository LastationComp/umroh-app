...
export default function AuthenticationPage() {
  ...
  return (
    <section className="flex flex-col gap-5 items-center">
      <span className="text-2xl font-bold">Masuk {process.env.NEXT_PUBLIC_APP_NAME}</span>
      <span className="text-sm text-center">Masukkan username dan password untuk login ke {process.env.NEXT_PUBLIC_APP_NAME}</span>
