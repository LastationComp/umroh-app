...
export default function HotelsForm({
  ...
  const clickHotel = async (hotelId: string) => {
    setSuspense(true);
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="grid gap-3">
              {hotelsData && hotelsData.filter(filterHotel).length === 0 && (
                <span>Tidak ada hotel yang bisa dipilih.</span>
              )}
